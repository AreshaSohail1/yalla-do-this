    ...
    <div className="relative w-full h-[650px] overflow-hidden">
      ...
      >
        ...
        <div className="relative flex flex-col  justify-center xl:items-start lg:items-start md:items-start sm:items-center items-center   z-10 text-white pt-[10%] px-[8%] p-8 xl:w-[50%] xl:text-start lg:w-[55%] lg:text-start md:w-[57%] md:mt-8 md:text-start sm:w-[100%] sm:mt-[150px] sm:text-center w-[100%] mt-[160px] text-center">
          <div className="text-[#1e73be] uppercase  font-bold mb-5 xl:text-[50px] lg:text-[50px] md:text-[47px] sm:text-[45px] text-[40px]">{content}</div>
          ...
          <Link href=' contactus' className="mt-[6%] bg-[#164b8d]   cursor-pointer hover:bg-[#F97300] text-center ease-in duration-300 font-[300] rounded-[30px] py-[10px] px-[25px] xl:text-[24px] xl: w-[43%] lg:text-[20px] lg: w-[43%] md:text-[20px] md:w-[63%] sm:text-[17px] sm:w-[53%] text-[15px]  w-[53%]">{button}</Link>
        </div>
      </div>
    </div>
  );
